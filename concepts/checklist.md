# NEAR Smart Contract Security Checklist
...
**Key Concepts**: security audit, deployment checklist, contract verification, security review, vulnerability prevention, pre-deployment testing

## How to Use This Checklist

1. **Go through each section systematically** - Don't skip items
2. **Verify each requirement** - Don't assume it's correct
3. **Test thoroughly** - Verify with actual code execution
4. **Get code reviews** - Have others review your implementation
5. **Document exceptions** - If you skip an item, document why

**Related Terms**: security audit process, code review, testing procedures, deployment safety
...
**Related Terms**: method visibility, access control, private methods, callback security
...
**Related Terms**: predecessor, signer, environment variables, access control, authorization

## Storage: Cost Management and Data Structures

### 3. State Growth Has Sufficient Balance Coverage

**Requirement**: Every time your contract's state grows (stores new data), ensure there is enough contract balance to cover the storage cost.
...
**Related Terms**: storage costs, balance management, storage attacks, cost coverage
...
**Related Terms**: collection IDs, storage keys, data integrity, state management
...
**Related Terms**: integer overflow, underflow, arithmetic safety, checked operations
...
**Related Terms**: balance management, storage reserves, fund management, contract sustainability
...
**Related Terms**: reentrancy prevention, state consistency, checks-effects-interactions, fund tracking
...
**Related Terms**: callback security, private callbacks, access control
...
**Related Terms**: cross-contract calls, async operations, callback handlers
...
**Related Terms**: error handling, state rollback, transaction atomicity, failure recovery
...
**Related Terms**: fund refunds, user money protection, callback refunds
...
**Related Terms**: error handling, panic prevention, graceful failures
...
**Related Terms**: gas allocation, callback execution, transaction completion
...
**Related Terms**: reentrancy prevention, state consistency, race conditions, async security
...
## Common Questions This Checklist Answers

- What should I check before deploying my NEAR contract?
...
- What storage considerations should I have?
- How do I handle user funds safely?
- What are common security mistakes in NEAR contracts?
