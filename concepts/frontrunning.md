# Frontrunning Attacks in NEAR Protocol
...
**Key Concepts**: frontrunning, MEV (Maximal Extractable Value), transaction ordering, validator manipulation, transaction pool, priority gas, sandwich attacks

## How Frontrunning Works in NEAR
...
**Related Terms**: mempool, transaction visibility, block production, validator privileges
...
**Related Terms**: transaction ordering attack, priority execution, information advantage
...
**Related Terms**: puzzle games, reward mechanisms, first-come-first-served, transaction priority
...
**Related Terms**: backrunning, arbitrage, price manipulation, gas wars
...
**Related Terms**: decentralized exchanges, NFT drops, auction security, oracle manipulation
...
**Related Terms**: cryptographic commitment, hash commitment, two-phase submission
...
**Related Terms**: economic security, slashing, deposit requirements
...
**Related Terms**: MEV, dark forest, blockchain security, transaction security

## Common Questions This Document Answers

- What is frontrunning in NEAR?
- How do validators frontrun transactions?
- How do I prevent frontrunning attacks?
- What is a commit-reveal scheme?
- How do I secure reward mechanisms from frontrunning?
- What is MEV and how does it relate to frontrunning?
- Can validators see my transactions before they execute?
- How do I design games that resist frontrunning?
